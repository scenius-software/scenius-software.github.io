...
var ToastService = /** @class */ (function () {
    ...
    ToastService.prototype.info = function (message) {
        var toast = new _toast__WEBPACK_IMPORTED_MODULE_2__["Toast"](message, _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"].info);
        this.toastAddedEvent.emit(toast);
    };
    ToastService.prototype.success = function (message) {
        var toast = new _toast__WEBPACK_IMPORTED_MODULE_2__["Toast"](message, _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"].success);
        this.toastAddedEvent.emit(toast);
    };
    ToastService.prototype.warn = function (message) {
        var toast = new _toast__WEBPACK_IMPORTED_MODULE_2__["Toast"](message, _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"].warning);
        this.toastAddedEvent.emit(toast);
    };
    ToastService.prototype.error = function (message) {
        var toast = new _toast__WEBPACK_IMPORTED_MODULE_2__["Toast"](message, _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"].error);
        this.toastAddedEvent.emit(toast);
    };
    ToastService.prototype.default = function (message) {
        var toast = new _toast__WEBPACK_IMPORTED_MODULE_2__["Toast"](message, _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"].default);
        this.toastAddedEvent.emit(toast);
    };
...
var ToastifyToastContainerComponent = /** @class */ (function () {
    ...
    ToastifyToastContainerComponent.prototype.getClass = function (toast) {
        var base = "toast toast--" + _toast_type__WEBPACK_IMPORTED_MODULE_3__["ToastType"][toast.type] + " ";
    ...
    ToastifyToastContainerComponent.prototype.ngOnInit = function () {
        ...
        this._toastService.toastAddedEvent.subscribe(function (toast) {
            _this.toastTransitionDict[toast.time] = TransitionState.entering;
            setTimeout(function () {
                _this.toastTransitionDict[toast.time] = TransitionState.noTransition;
                _this._cd.markForCheck();
...
var ToastifyToastComponent = /** @class */ (function () {
    function ToastifyToastComponent(_cd) {
        this._cd = _cd;
        this.autoClose = 5000;
        this.hideProgressBar = false;
        this.pauseOnHover = true;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(_toastService) {
        this._toastService = _toastService;
